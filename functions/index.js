...
  }
});nctions = require("firebase-functions");
const admin = require("firebase-admin");
...
exports.getSupportAssignableUsers = onCall({
    // THIS IS THE FIX: This option explicitly allows your web app to call this function.
    cors: [/flying-kids-hr-management\.web\.app$/, /firebase\.com$/]
}, async (request) => {
    if (!request.auth) {
        throw new HttpsError('unauthenticated', 'The function must be called while authenticated.');
    }
